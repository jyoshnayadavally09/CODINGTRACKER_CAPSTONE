          ...
          <div className="progress-circles-container">
            ...
            <div className="progress-circle-item">
              <svg className="progress-circle-svg" width="120" height="120">
                ...
                />
                <text className="progress-text-solved" x="60" y="60" textAnchor="middle" dominantBaseline="middle">
                  {easy}
                </text>
                <text className="progress-text-label" x="60" y="85" textAnchor="middle" dominantBaseline="middle">
                  Easy
                </text>
              </svg>
            </div>
